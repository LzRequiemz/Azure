...
function sectiontable:RadioButton(Info)
    ...
    local RadioYSize = 27  -- Start with a base height
    ...
    -- Create the base radio button frame
    ...
    radioButton.Size = UDim2.new(0, 162, 0, RadioYSize)
    ...
    -- Text button to toggle the dropdown
    local button = Instance.new("Frame")
    button.Name = "Button"
    button.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    button.BackgroundTransparency = 1
    button.Size = UDim2.new(0, 162, 0, RadioYSize)
    ...
    radioButtonTextButton.Size = UDim2.new(0, 162, 0, RadioYSize)
    ...
    radioButtonText.Size = UDim2.new(0, 156, 0, RadioYSize)
    ...
    radioContainer.Size = UDim2.new(0, 162, 0, RadioYSize)
