...
function sectiontable:Toggle(Info)
    ...
    ColorElements[toggleFrame] = {Type = "Toggle", Enabled = Toggled}
    ...
    circleIcon.Position = Toggled and UDim2.new(0, 16, 0.067, 0) or UDim2.new(0, 1, 0.067, 0)
    circleIcon.Size = UDim2.new(0, 13, 0, 13)
    circleIcon.Parent = toggleFrame

    local function tweenToggleColors(on)
        TweenService:Create(toggleFrame, TweenInfo.new(0.15, Enum.EasingStyle.Linear), {
            BackgroundColor3 = on and _G.UIColor or Color3.fromRGB(68, 68, 68)
        }):Play()
    end
    ...
    function insidetoggle:Set(bool)
        ...
        -- Move circle
        TweenService:Create(circleIcon, TweenInfo.new(0.15, Enum.EasingStyle.Linear), {
        ...
        -- Always call callback and debug print
        pcall(function()
